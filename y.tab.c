...
#line 38 "hi.y"
    {
				...
				VP=sparser->public.get_node_info(sparser,(yyvsp[(2) - (2)]));
				printf("S->NP VP\n");
				return 0;
}
    break;
...
#line 60 "hi.y"
    {
				...
				Vdt=sparser->public.get_node_info(sparser,(yyvsp[(1) - (2)]));
...
#line 105 "hi.y"
    {
				...
				CNP=sparser->public.get_node_info(sparser,(yyvsp[(1) - (1)]));
				(yyval)=sparser->public.set_node_info(sparser,"NP",NULL,CNP);
				printf("NP->CNP\n");
}
    break;
...
#line 134 "hi.y"
    {
				...
				A=sparser->public.get_node_info(sparser,(yyvsp[(1) - (2)]));
				CNP=sparser->public.get_node_info(sparser,(yyvsp[(2) - (2)]));
...
#line 149 "hi.y"
    {
				...
				N=sparser->public.get_node_info(sparser,(yyvsp[(1) - (1)]));
				(yyval)=sparser->public.set_node_info(sparser,"CNP",NULL,N);
				printf("CNP->N:%s\n",N->expression);
}
    break;
...
#line 226 "hi.y"
    {
				...
				Con=sparser->public.get_node_info(sparser,(yyvsp[(1) - (1)]));
				(yyval)=sparser->public.set_node_info(sparser,"N",NULL,Con);
				printf("N->%s\n",Con->expression);
}
    break;
