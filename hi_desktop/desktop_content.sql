...
insert into RULE_TO_RULE_MAP values( 'ENG_CNP', 'ENG_AP', 'ENG_N', '1', '2', NULL, 'N', NULL, 'N', NULL, 'CONJ', NULL, 'H', NULL, 'ENG');
insert into RULE_TO_RULE_MAP values( 'ENG_CNP', 'ENG_AP', 'ENG_N', '2', '3', NULL, 'N', NULL, 'N', NULL, 'ANEG', NULL, 'H', NULL, 'ENG');
insert into RULE_TO_RULE_MAP values( 'ENG_CNP', 'ENG_AP', 'ENG_N', '3', NULL, NULL, 'N', NULL, 'N', NULL, 'A', NULL, 'H', NULL, 'ENG');
...
insert into RULE_TO_RULE_MAP values( 'ENG_VP', 'ENG_Vbar1', 'ENG_RC', '4', '5', NULL, 'V', NULL, 'N', NULL, 'CONJ', NULL, 'H', NULL, 'ENG');
insert into RULE_TO_RULE_MAP values( 'ENG_VP', 'ENG_Vbar1', 'ENG_RC', '5', '6', NULL, 'V', NULL, 'N', NULL, 'ANEG', NULL, 'H', NULL, 'ENG');
insert into RULE_TO_RULE_MAP values( 'ENG_VP', 'ENG_Vbar1', 'ENG_RC', '6', '6', NULL, 'V', NULL, 'N', NULL, 'A', NULL, 'H', NULL, 'ENG');
...
insert into RULE_TO_RULE_MAP values( 'ENG_IVP', 'ENG_V', 'ENG_AP', '1', '2', NULL, 'V', NULL, 'H', NULL, 'CONJ', NULL, 'N', NULL, 'ENG');
insert into RULE_TO_RULE_MAP values( 'ENG_IVP', 'ENG_V', 'ENG_AP', '2', '3', NULL, 'V', NULL, 'H', NULL, 'ANEG', NULL, 'N', NULL, 'ENG');
insert into RULE_TO_RULE_MAP values( 'ENG_IVP', 'ENG_V', 'ENG_AP', '3', NULL, NULL, 'V', NULL, 'H', NULL, 'A', NULL, 'N', NULL, 'ENG');
insert into RULE_TO_RULE_MAP values( 'ENG_IVP', 'ENG_NV', 'ENG_AP', '1', NULL, '2', 'V', NULL, 'H', NULL, 'VNEG', NULL, 'H', NULL, 'ENG');
insert into RULE_TO_RULE_MAP values( 'ENG_IVP', 'ENG_NV', 'ENG_AP', '2', '3', NULL, 'VNEG', NULL, 'H', NULL, 'CONJ', NULL, 'N', NULL, 'ENG');
insert into RULE_TO_RULE_MAP values( 'ENG_IVP', 'ENG_NV', 'ENG_AP', '3', '4', NULL, 'VNEG', NULL, 'H', NULL, 'ANEG', NULL, 'N', NULL, 'ENG');
insert into RULE_TO_RULE_MAP values( 'ENG_IVP', 'ENG_NV', 'ENG_AP', '4', NULL, NULL, 'VNEG', NULL, 'H', NULL, 'A', NULL, 'N', NULL, 'ENG');
...
insert into DEPOLEX values('PROPERTIES', '2', '1', '1', '2', '2', '1', 'ANDENGCONJ', '2');
insert into DEPOLEX values('PROPERTIES', '2', '2', '1', '3', '3', '1', 'NOTENGANEG', '2');
insert into DEPOLEX values('PROPERTIES', '2', '3', '1', '3', NULL, '0', 'DIRBEPROP', '1');
...
insert into DEPOLEX values('FILEBEPROP', '1', '1', '1', '2', '2', '1', 'NOTENGANEG', '1');
insert into DEPOLEX values('FILEBEPROP', '1', '2', '1', '3', '3', '1', 'ANDENGCONJ', '1');
insert into DEPOLEX values('FILEBEPROP', '1', '3', '1', '4', '4', '0', 'EXECUTABLEENGA', '1');
insert into DEPOLEX values('FILEBEPROP', '1', '4', '1', NULL, NULL, '0', 'INENGPREP', '1');
insert into DEPOLEX values('NOTENGANEG', '1', '1', '1', '1', NULL, '0', 'FILEBEPROP', '1');
...
insert into GRAMMAR values('ENG','ENG_Abar1','ENG_A',NULL,NULL);
...
insert into GRAMMAR values('ENG','ENG_ACONJ','ENG_Abar1','ENG_CONJ',NULL);
...
insert into GRAMMAR values('ENG','ENG_Abar2','ENG_ACONJ','ENG_Alist',NULL);
