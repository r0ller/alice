...
%token	t_ENG_PAR 16
%token	t_ENG_DET_Indef 17
%token	t_ENG_DET_fwVowel 18
%token	t_ENG_DET_fwConsonant 19
%token	t_ENG_N_swVowel 20
%token	t_ENG_N_swConsonant 21
%token	t_ENG_V_Gerund 22
%token	t_ENG_CONJ_Stem 23
%token	t_ENG_Num_Stem 24
%token	t_ENG_Num_Ord 25
%token	t_ENG_Num_Npref1n 26
%token	t_ENG_Num_Npref2n 27
%token	t_ENG_Num_Npref3n 28
%token	t_ENG_Num_Npref4n 29
%token	t_ENG_Num_Npref5n 30
%token	t_ENG_Num_Npref6n 31
%token	t_ENG_Num_Npref7n 32
%token	t_ENG_Num_Npref8n 33
%token	t_ENG_Num_Npref9n 34
%token	t_ENG_Num_swVowel 35
%token	t_ENG_Num_swConsonant 36
%token	t_ENG_DET_Def 37
%token	t_HUN_Num_Stem 126
%token	t_HUN_Num_Ik 127
%token	t_HUN_Num_Par 128
%token	t_HUN_Num_Npref1 129
%token	t_HUN_Num_Npref2 130
%token	t_HUN_Num_Npref3 131
%token	t_HUN_Num_Npref4 132
%token	t_HUN_Num_Npref5 133
%token	t_HUN_Num_Npref6 134
%token	t_HUN_Num_Npref7 135
%token	t_HUN_Num_Npref8 136
%token	t_HUN_Num_Npref9 137
%token	t_HUN_Num_Npref1nn 138
%token	t_HUN_Num_Npref1nnn 139
%token	t_HUN_Det 140
%token	t_HUN_Det_Def 141
%token	t_HUN_Det_fwVowel 142
%token	t_HUN_Det_fwConsonant 143
%token	t_HUN_CON_swVowel 144
%token	t_HUN_CON_swConsonant 145
%token	t_HUN_Num_Acc 146
%token	t_HUN_Num_Npref1n 147
%token	t_HUN_Num_Npref2n 148
%token	t_HUN_Num_Npref3n 149
%token	t_HUN_Num_Npref4n 150
%token	t_HUN_Num_Npref5n 151
%token	t_HUN_Num_Npref6n 152
%token	t_HUN_Num_Npref7n 153
%token	t_HUN_Num_Npref8n 154
%token	t_HUN_Num_Npref9n 155
%token	t_HUN_Num_swVowel 156
%token	t_HUN_Num_swConsonant 157
%token	t_HUN_Noun_Stem 158
%token	t_HUN_Noun_Acc 159
%token	t_HUN_Noun_swVowel 160
%token	t_HUN_Noun_swConsonant 161
%token	t_HUN_CON_Acc 162
%token	t_HUN_Verb_Stem 163
%token	t_HUN_Verb_ConjDefSg2 164
%token	t_HUN_Vbpfx_Stem 165
%token	t_HUN_Noun_Relative 166
%token	t_HUN_Conj_Stem 167
%token	t_HUN_Neg_Stem 168
%token	t_HUN_Noun_Plur 169
%token	t_HUN_Noun_Ine 170
%token	t_HUN_Verb_IndefSg3 171
%token	t_HUN_Verb_ConjIndefSg2 172
%token	t_HUN_Adj_Stem 173
%token	t_HUN_CON_Sub 174
%token	t_HUN_CON_Ins 175
%token	t_HUN_Verb_IndefPl3 176

%precedence t_Con t_HUN_Num_Stem t_HUN_CON_swVowel t_HUN_CON_swConsonant t_HUN_Num_swVowel t_HUN_Num_swConsonant t_HUN_Noun_Stem t_HUN_Noun_swVowel t_HUN_Noun_swConsonant t_HUN_Neg_Stem t_HUN_Adj_Stem
...
{
lexicon word;
word=lex->last_word_scanned(t_ENG_Num_Npref1n);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
...
{
lexicon word;
word=lex->last_word_scanned(t_ENG_Num_Npref2n);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
$$=sparser->set_node_info("ENG_Num_Pref",word);
...
{
lexicon word;
word=lex->last_word_scanned(t_ENG_Num_Npref3n);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
$$=sparser->set_node_info("ENG_Num_Pref",word);
...
{
lexicon word;
word=lex->last_word_scanned(t_ENG_Num_Npref4n);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
$$=sparser->set_node_info("ENG_Num_Pref",word);
...
{
lexicon word;
word=lex->last_word_scanned(t_ENG_Num_Npref5n);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
$$=sparser->set_node_info("ENG_Num_Pref",word);
...
{
lexicon word;
word=lex->last_word_scanned(t_ENG_Num_Npref6n);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
$$=sparser->set_node_info("ENG_Num_Pref",word);
...
{
lexicon word;
word=lex->last_word_scanned(t_ENG_Num_Npref7n);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
$$=sparser->set_node_info("ENG_Num_Pref",word);
...
{
lexicon word;
word=lex->last_word_scanned(t_ENG_Num_Npref8n);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
$$=sparser->set_node_info("ENG_Num_Pref",word);
...
{
lexicon word;
word=lex->last_word_scanned(t_ENG_Num_Npref9n);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
$$=sparser->set_node_info("ENG_Num_Pref",word);
...
{
lexicon word;
word=lex->last_word_scanned(t_ENG_Num_Stem);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
...
{
lexicon word;
word=lex->last_word_scanned(t_ENG_Num_Ord);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
...
{
lexicon word;
word=lex->last_word_scanned(t_ENG_DET_Def);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
...
{
lexicon word;
word=lex->last_word_scanned(t_HUN_Adj_Stem);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
...
{
lexicon word;
word=lex->last_word_scanned(t_HUN_CON_Ins);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
...
{
lexicon word;
word=lex->last_word_scanned(t_HUN_CON_Sub);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
...
{
lexicon word;
word=lex->last_word_scanned(t_HUN_Conj_Stem);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
...
{
lexicon word;
word=lex->last_word_scanned(t_HUN_Neg_Stem);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
...
{
lexicon word;
word=lex->last_word_scanned(t_HUN_Noun_Ine);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
...
{
lexicon word;
word=lex->last_word_scanned(t_HUN_Noun_Plur);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
...
{
lexicon word;
word=lex->last_word_scanned(t_HUN_Noun_Relative);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
...
{
lexicon word;
word=lex->last_word_scanned(t_HUN_Verb_ConjIndefSg2);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
...
{
lexicon word;
word=lex->last_word_scanned(t_HUN_Verb_IndefPl3);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
