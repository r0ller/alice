...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 8882256,
    DYNAMIC_BASE = 14125136,
    DYNAMICTOP_PTR = 8882080;
...
var wasmBinaryFile = 'hi_qml_ui.wasm';
...
var ASM_CONSTS = {
  1051: function($0) {window.onmessage=function(e){ window.msgPort=e.ports[0]; window.msgPort.onmessage=function(f){ dynCall('vi',$0,[allocate(intArrayFromString(f.data),'i8',ALLOC_NORMAL)]); } }},  
 1229: function($0) {window.msgPort.postMessage(UTF8ToString($0));},  
 9213: function() {console.log('Refresh');}
};
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=8882240;function __emscripten_get_fetch_work_queue() {
  ...
  var ___tm_current=8882096;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 8882144, 4), 8882144);
