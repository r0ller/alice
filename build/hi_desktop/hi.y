...
|ENG_Vbar1_Ind ENG_AP
{
const node_info& ENG_Vbar1_Ind=sparser->get_node_info($1);
const node_info& ENG_AP=sparser->get_node_info($2);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,"ENG_VP->ENG_Vbar1_Ind ENG_AP");
$$=sparser->combine_nodes("ENG_VP",ENG_Vbar1_Ind,ENG_AP);

}
|ENG_Vbar1_Ind ENG_DP
{
const node_info& ENG_Vbar1_Ind=sparser->get_node_info($1);
...
$$=sparser->combine_nodes("ENG_VP",ENG_Vbar1_Ind,ENG_DP);
...
|ENG_VP_Int 
{
const node_info& ENG_VP_Int=sparser->get_node_info($1);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,"S->ENG_VP_Int");
$$=sparser->set_node_info("S",ENG_VP_Int);
