...
JSON_ClosingCBracket:
JSON_Punct_Stem JSON_Punct_ClosingCBracket
{
const node_info& JSON_Punct_Stem=sparser->get_node_info($1);
const node_info& JSON_Punct_ClosingCBracket=sparser->get_node_info($2);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,"JSON_ClosingCBracket->JSON_Punct_Stem JSON_Punct_ClosingCBracket");
$$=sparser->combine_nodes("JSON_ClosingCBracket",JSON_Punct_Stem,JSON_Punct_ClosingCBracket);
...
JSON_Closing_Key_Value_Pair:
JSON_Key_Value_Pair JSON_ClosingCBracket
{
const node_info& JSON_Key_Value_Pair=sparser->get_node_info($1);
const node_info& JSON_ClosingCBracket=sparser->get_node_info($2);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,"JSON_Closing_Key_Value_Pair->JSON_Key_Value_Pair JSON_ClosingCBracket");
$$=sparser->combine_nodes("JSON_Closing_Key_Value_Pair",JSON_Key_Value_Pair,JSON_ClosingCBracket);
...
JSON_Key_Value_List_Element:
JSON_Key_Value_Pair JSON_Comma
{
const node_info& JSON_Key_Value_Pair=sparser->get_node_info($1);
...
$$=sparser->combine_nodes("JSON_Key_Value_List_Element",JSON_Key_Value_Pair,JSON_Comma);
...
$$=sparser->set_node_info("JSON_Number",JSON_CON);

};
JSON_Object:
JSON_Open_Object JSON_Closing_Key_Value_Pair
{
...
JSON_Open_Object:
JSON_Open_Object JSON_Key_Value_List_Element
{
const node_info& JSON_Open_Object=sparser->get_node_info($1);
const node_info& JSON_Key_Value_List_Element=sparser->get_node_info($2);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,"JSON_Open_Object->JSON_Open_Object JSON_Key_Value_List_Element");
$$=sparser->combine_nodes("JSON_Open_Object",JSON_Open_Object,JSON_Key_Value_List_Element);

}
|JSON_OpeningCBracket 
{
const node_info& JSON_OpeningCBracket=sparser->get_node_info($1);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,"JSON_Open_Object->JSON_OpeningCBracket");
$$=sparser->set_node_info("JSON_Open_Object",JSON_OpeningCBracket);
...
JSON_OpeningCBracket:
JSON_Punct_Stem JSON_Punct_OpeningCBracket
{
const node_info& JSON_Punct_Stem=sparser->get_node_info($1);
const node_info& JSON_Punct_OpeningCBracket=sparser->get_node_info($2);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,"JSON_OpeningCBracket->JSON_Punct_Stem JSON_Punct_OpeningCBracket");
$$=sparser->combine_nodes("JSON_OpeningCBracket",JSON_Punct_Stem,JSON_Punct_OpeningCBracket);
...
JSON_Punct_ClosingCBracket:
t_JSON_Punct_ClosingCBracket 
{
lexicon word;
word=lex->last_word_scanned(token::t_JSON_Punct_ClosingCBracket);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
$$=sparser->set_node_info("JSON_Punct_ClosingCBracket",word);
...
t_JSON_Punct_OpeningCBracket 
{
lexicon word;
word=lex->last_word_scanned(token::t_JSON_Punct_OpeningCBracket);
logger::singleton()==NULL?(void)0:logger::singleton()->log(0,word.gcat+"->"+word.lexeme);
$$=sparser->set_node_info("JSON_Punct_OpeningCBracket",word);
...
$$=sparser->set_node_info("S",JSON_Object);
