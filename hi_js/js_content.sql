...
insert into RULE_TO_RULE_MAP values( 'ENG_VP', 'ENG_VBAR2', 'ENG_PP', '1', NULL, NULL, 'V', NULL, 'H', NULL, 'PREP', NULL, 'N', NULL, 'ENG');
...
insert into DEPOLEX values('LOCATIONENGN', '1', '1', NULL, NULL, NULL, NULL, NULL, NULL);
insert into DEPOLEX values('OFENGPREP', '1', '1', NULL, '1', NULL, '0', 'RESTAURANTENGN', '1');
insert into DEPOLEX values('OFENGPREP', '2', '1', NULL, NULL, NULL, '0', 'CON', '1');
insert into DEPOLEX values('RESTAURANTENGN', '1', '1', '1', '1', NULL, '0', 'CON', '1');
insert into DEPOLEX values('SHOWENGV', '1', '1', NULL, '4', '2', '0', 'LOCATIONENGN', '1');
insert into DEPOLEX values('SHOWENGV', '1', '2', NULL, NULL, '3', '0', 'OFENGPREP', '1');
insert into DEPOLEX values('SHOWENGV', '1', '3', NULL, '3', NULL, '0', 'INENGPREP', '1');
insert into DEPOLEX values('SHOWENGV', '1', '4', NULL, '5', '5', '0', 'RESTAURANTENGN', '1');
insert into DEPOLEX values('SHOWENGV', '1', '5', NULL, '5', NULL, '0', 'INENGPREP', '1');
